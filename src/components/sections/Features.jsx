        ...
        <section className="features-section" id="features">
            <div className="container">
                ...
                <div className="features-grid grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
                    {
                        features.map((feature, index) => (<div className="feature-card p3 md:p-5 text-center border-b-2 border-b-grey-100 transition-colors duration-200 sm:hover:border-b-primary" key={index}>
