...
function SectionHeader({ beforeTtitle, title, description, children }) {
    return (
        <div className="section-header flex sm:items-center justify-between mb-5 md:mb-10 max-md:flex-wrap max-sm:flex-col gap-3">
